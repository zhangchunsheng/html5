...
TheShodo.Shodo.StrokeManager.prototype.toDataURL = function () {
...
TheShodo.Shodo.StrokeManager.prototype.addStrokePosition = function (x, y) {
...
TheShodo.Shodo.StrokeManager.prototype.startRx = function () {
    /// <summary></summary>
    /// <return>TheShodo.Shodo.StrokeManager</return>
...
TheShodo.Shodo.StrokeEngine.prototype.toDataURL = function () {
    /// <summary>Get Image data URI</summary>
...
TheShodo.Shodo.StrokeEngine.prototype.createBrushWithOpacity = function (brushName, brushOpacity) {
...
TheShodo.Shodo.StrokeEngine.prototype.selectBrush = function (brushName) {
    /// <summary>Select a brush</summary>
    this.currentBrush = TheShodo.Shodo.Brushes.getBrush(brushName);
...
TheShodo.Shodo.StrokeEngine.prototype.drawStroke = function (ctx, startPos, endPos, brushSize, distance, velocity) {
