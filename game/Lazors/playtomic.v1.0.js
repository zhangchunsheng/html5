...
Playtomic.Leaderboards.ListFB = function(table, callback, options)
{
	...
	Playtomic.PostData(postdata, Playtomic.APIUrl + "leaderboards/listfb.aspx?swfid=" + Playtomic.SWFID + "&js=true&url=" + (global ? "global" : Playtomic.SourceURL) + "&mode=" + mode + "&filters=" + numcustomfilter + "&table=" + escape(table) + "&page=" + page + "&perpage=" + perpage, bridge, failvalue);
}
