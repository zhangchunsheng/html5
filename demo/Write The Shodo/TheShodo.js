...
if (!$TS.isPanelContent && $('body').is('.home, .gallery, .signin, .write')) {
	...
	if ($TS.OS.isIE9Installable) {
		alertHTML = [
			...
			, '<p>FUNCTION LIMITED. Get the best experience with Internet Explorer 9.</p>'
			, '<div class="link"><a href="http://www.beautyoftheweb.com" target="_blank">Beauty of the Web for Upgrading to Internet Explorer 9</a></div>'
			, '</div>'
		].join('');
	} else {
		alertHTML = [
			  '<div class="useragent-alert">'
			, '<p>FUNCTION LIMITED. Get the best experience with Internet Explorer 9.</p>'
			, '<div class="link"><a href="http://www.beautyoftheweb.com" target="_blank">Beauty of the Web for Upgrading to Internet Explorer 9</a> <span class="note">* Internet Explorer 9 requires Windows Vista or Windows 7.</span></div>'
			, '</div>'
		].join('');
	}
