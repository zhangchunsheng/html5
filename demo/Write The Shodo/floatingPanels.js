...
// -- Ink Select Panel ------------------------------------------------------
//
TheShodo.Shodo.Write.PanelSelectInk = function (selectedOpacity) {
    ...
    this.buttons = [
        {
            label: TheShodo.Shodo.Resources.Write.String.Panel_OK || 'OK',
            onClick: function (sender, e) {
                sender.onInkSelected(sender.selectedOpacity, '');
                sender.close();
            }
        }
    ];
...
TheShodo.Shodo.Write.PanelSelectInk.prototype.onBeforePanelShow = function (selectedOpacity) {
    var self = this;
...
TheShodo.Shodo.Write.PanelFinish.prototype.onBeforePanelShow = function (imageDataUrl) {
    ...
    var tenkokuNormalizer = function (s) { return s.replace(/[^a-zA-Z0-9\-]/g, '').replace(/(^\s+|\s+$)/g, '');}
    ...
    this.content
        ...
        .find('.tenkoku-input:input')
            ...
            .keyup($.proxy(function (e) {
                e.target.value = tenkokuNormalizer(e.target.value);
